"""
FastAPI REST API Server for Fe Urea Calculator.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "fe-urea-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
