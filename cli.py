"""
Command Line Interface for Fe Urea Calculator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="fe-urea-calculator", description="Fe Urea Calculator")
    ...
    if args.command == "serve":
        ...
        print(f"Starting Fe Urea Calculator API server on http://{args.host}:{args.port}")
